...
CREATE TABLE IF NOT EXISTS `Trabalho_Seguro`.`Esqueceu_senha` (
  ...
  PRIMARY KEY (`idEsqueceu_senha`),
  INDEX `fk_Esqueceu_senha_Login1_idx` (`Login_idLogin` ),
  CONSTRAINT `fk_Esqueceu_senha_Login1`
...
CREATE TABLE IF NOT EXISTS `Trabalho_Seguro`.`Cadastro_Empresa` (
  ...
  `Login_idLogin` INT NOT NULL,
  `comprovante` TEXT(1200) NOT NULL,
