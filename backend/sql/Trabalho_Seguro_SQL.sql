...
CREATE TABLE acidente_incidente (
  ...
  agente VARCHAR(100),
  acidentes_anteriores BOOLEAN,
  quantidade_acidentes INT,
  confirmacao_testemunha BOOLEAN,
  testemunha_info TEXT,
  afastamento BOOLEAN,
...
CREATE TABLE IF NOT EXISTS `Trabalho_Seguro`.`Registra` (
  ...
  `Acidente_Incidente_id` INT NOT NULL,
  `Desvio_idDesvio` INT NOT NULL,
  PRIMARY KEY (`Funcionario_id_funcionario`),
  INDEX `fk_Registra_Funcionario1_idx` (`Funcionario_id_funcionario` ),
  INDEX `fk_Registra_Acidente_Incidente1_idx` (`Acidente_Incidente_id` ),
  ...
  CONSTRAINT `fk_Registra_Funcionario1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Registra_Acidente_Incidente1`
    FOREIGN KEY (`Acidente_Incidente_id`)
    REFERENCES `Trabalho_Seguro`.`Acidente_Incidente` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
