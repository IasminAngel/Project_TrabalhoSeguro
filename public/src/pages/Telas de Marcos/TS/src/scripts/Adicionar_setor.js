...
export var exp_inp_func = "insira algo aqui";

let add;
add = document.getElementById("btn_add_member");
add.addEventListener("click", function() {
    ...
    // agrupando os filhos ao pai
     ...
     exp_inp_func = input_function.value;
     
});

export var exp_tecnico_value;
...
btn_enviar.addEventListener("click", function() {
     ...
     contador = 0;
     const tecnico_value = document.getElementById("setor_technic").value;
     exp_tecnico_value = tecnico_value;
